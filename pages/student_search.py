...
#     for student in data:
#         if (
#             search_term in student["Seat No"].lower()
...
#                     for x in detailed["Total"]
#                 )
#                 passed_subjects = sum(
#                     1 for status in detailed["Status1"] if status == "P"
#                 )
                
#                 st.metric("Total Marks", total_marks)
#                 st.metric(
#                     "Passed Subjects",
#                     f"{passed_subjects}/{len(detailed['Status1'])}"
#                 )
#                 st.metric(
#                     "Overall Percentage",
#                     detailed["Percentage"] + "%"
